# 2023-12-08 : Model1 using chest MNIST pretrained check by epoch 1
# 2023-12-09 : Run with 50 epochs
...
# slurm-257201.out : check dimension with 1 epoch
# slurm-259904.out : Run with 50 epochs

print("***** Run with 50 epochs *****")
"""# Setting"""
import argparse
import os
import numpy as np
