...
#slurm-277547.out : evaluation 차원 쪽 에러 확인
#slurm-277601.out: Check with 1 epoch
#slurm-277696.out : pneumonia Ratio 조절 추가 100%짜리로 만들기
#slurm-277701.out : Run with 50 epochs, no ratio
...
model_name = 'DeiT_pneu_synthetic'
...
# pth 불러오기
model.load_state_dict(torch.load(f'{PATH}/DeiT_pneu_synthetic.pth'))
model.to(device)
#model.eval()
