# 2023-12-09 : chestMNIST pre-trained -> train pneumonia MNIST -> train synthetic
...
# slurm-259921.out : check dimension with 1 epoch
# slurm-259923.out : Run with 50 epochs
